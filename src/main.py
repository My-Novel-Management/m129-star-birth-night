...
COPY = "星がなくなった世界で、それでも星を見たいと願う。"
ONELINE = "約8000字のファンタジィ短編。星が見えなくなってしまった世界で、少年と男は自作の星を打ち上げようとした"
OUTLINE = "星が見えなくなってしまった世界で用無しとなった天文台は廃棄されることになる。男は星を見たいという男の子のために星を作ろうとするが。"
THEME = "現実を夢は超えてくいく"
GENRE = "ファンタジィ"
TARGET = "10台から30台（男女）"
SIZE = "〜8K"
